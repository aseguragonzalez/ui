...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the maintainers at **a.segura.gonzalez@gmail.com**. All complaints will be reviewed and investigated promptly and fairly.
...
**1. Correction** — A private written warning with an explanation of the violation. A public apology may be requested.

**2. Warning** — A warning with consequences for continued behaviour. No interaction with the people involved for a specified period, including unsolicited interaction with those enforcing the code of conduct.
