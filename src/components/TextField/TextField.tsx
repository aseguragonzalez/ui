...
import { TextInput, type TextInputSize } from '../../primitives/TextInput/TextInput';
...
/**
 * Composite field: Label + TextInput + Hint/Error.
 * Manages all accessibility wiring (htmlFor, aria-describedby, aria-invalid, aria-required).
 */
